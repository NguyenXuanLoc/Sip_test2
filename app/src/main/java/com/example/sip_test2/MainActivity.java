...
//	    app.handleNetworkChange();
    ...
    private void dlgAccountSetting() {
        ...
        */
        etId.setText("sip:7002@104.248.154.11");
        etReg.setText("sip:104.248.154.11");
        etUser.setText("7002");
        etPass.setText("7002");
        ...
        adb.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Log.e("TAG", "ecc_id: " + acc_id);
                        Log.e("TAG", "registrar: " + registrar);
                        Log.e("TAG", "userNa,e: " + username);
    ...
    public void makeCall(View view) {
        if (buddyListSelectedIdx == -1) {
            Log.e("TAG", "buddyListSelectedIdx =-1 => return");
            return;
        }
...
//         Only one call at anytime
    ...
    public void notifyBuddyState(MyBuddy buddy) {
        Log.e("TAG", "notifyBuddyState: " + buddy.getStatusText());
